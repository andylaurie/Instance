...
<script src="http://server.ac-home.net:2247/Instance/assets/js/printStock.js" type="text/javascript" charset="UTF-8"></script>
<?php include('includes/handlers/stock-selected-handler.php'); ?>
